        ...
        public ContentResult Tasks()
        {
            string html = """
                ...
                <p> URL with filter paramater <br>
                    ...
                    <a href="http://localhost:7028/analyzer?filter=-1&url=https://flapotest.blob.core.windows.net/test/ProductData.json&price=17.99" target="_blank"> Task All above: All answers to tasks </a><br>
                </p>
                <p> URL with different routes <br>
                    ...
                    <a href="http://localhost:7028/analyzer/all?url=https://flapotest.blob.core.windows.net/test/ProductData.json&price=17.99" target="_blank"> Task All above: All answers to tasks </a>
                """;
